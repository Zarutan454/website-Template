# Generated by Django 5.0.2 on 2025-06-21 20:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "referral_validation_date",
                    models.DateTimeField(blank=True, null=True),
                ),
                (
                    "ico_investment_amount",
                    models.DecimalField(decimal_places=2, default=0, max_digits=10),
                ),
                (
                    "investment_validation_date",
                    models.DateTimeField(blank=True, null=True),
                ),
                (
                    "influencer_category",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="bsn_social_network.demotoken",
                    ),
                ),
                (
                    "from_user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="demo_sent_transactions",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="demo_received_transactions",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tokens",
                        to="bsn_social_network.smartcontract",
                    ),
                ),
                (
                    "owner",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="token_streams_received",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="token_streams_sent",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="bsn_social_network.achievement",
                    ),
                ),
                (
                    "user",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="votes",
                        to="bsn_social_network.proposal",
                    ),
                ),
                (
                    "voter",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("dao", "user"), name="unique_dao_membership"
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "status"], name="ico_token_r_user_id_06567a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="icotokenreservation",
            index=models.Index(
                ...
                name="ico_token_r_payment_cd367e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="icotokenreservation",
            index=models.Index(
                fields=["expires_at"], name="ico_token_r_expires_10de54_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="message",
        ...
        migrations.AddConstraint(
            model_name="referral",
            constraint=models.UniqueConstraint(
                fields=("referrer", "referred"), name="unique_referral"
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name="vote",
            constraint=models.UniqueConstraint(
                fields=("proposal", "voter"), name="unique_proposal_vote"
            ),
        ),
    ]
