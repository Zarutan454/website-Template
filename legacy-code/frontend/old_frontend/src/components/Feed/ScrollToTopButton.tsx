...
// Diese Datei wird nicht mehr benötigt, aber ich behalte sie im Projekt,
// da sie möglicherweise in anderen Komponenten verwendet wird.
// Der Button wird nur aus der Feed-Seite entfernt.
