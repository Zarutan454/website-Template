...
export const translations = {
  de: {
    ...
    'register.emailPlaceholder': 'deine.email@beispiel.com',
    ...
    'register.sign_in': 'bei deinem bestehenden Konto anmelden',
    ...
    'hero.subtitle': 'Verbinde dich, teile Inhalte und verdiene BSN-Tokens durch deine Aktivität',
    'hero.cta.register': 'Jetzt registrieren',
    'hero.cta.learn-more': 'Mehr erfahren',
    'features.title': 'Revolutionäre Features',
    'features.subtitle': 'BSN kombiniert das Beste aus Social Networking mit Blockchain-Technologie, um eine einzigartige Plattform zu schaffen, auf der deine soziale Aktivität echten Wert hat.',
    'features.token-mining': 'Token Mining',
    'features.token-mining.desc': 'Verdiene BSN-Tokens durch soziale Interaktionen, Content-Erstellung und tägliche Plattform-Aktivität.',
    'features.social-networking': 'Social Networking',
    'features.social-networking.desc': 'Verbinde dich mit Gleichgesinnten in der Blockchain- und Crypto-Community.',
    'features.decentralized-identity': 'Dezentrale Identität',
    'features.decentralized-identity.desc': 'Besitze deine Daten mit blockchain-basiertem Identitäts- und Reputationssystem.',
    'features.token-analytics': 'Token Analytics',
    'features.token-analytics.desc': 'Verfolge deine Einnahmen und überwache die Token-Performance mit Echtzeit-Analytics.',
    'features.token-creation': 'Token Erstellung',
    'features.token-creation.desc': 'Starte deine eigenen benutzerdefinierten Tokens mit unserem benutzerfreundlichen Token-Erstellungs-Assistenten.',
    'features.secure-wallet': 'Sichere Wallet',
    'features.secure-wallet.desc': 'Verwalte deine Crypto-Assets mit unserem integrierten sicheren Wallet-System.',
    'social.title': 'Social Features',
    'social.subtitle': 'Mehr als nur ein Blockchain-Projekt',
    'social.description': 'BSN kombiniert das Beste aus Social Networks mit den Vorteilen der Blockchain-Technologie. Baue deine Community auf, belohne aktive Mitglieder und erstelle ein florierendes Ökosystem.',
    ...
    'mining.subtitle': 'Verdiene Tokens durch soziale Interaktionen',
    'mining.description': 'Unser einzigartiger Proof-of-Activity-Algorithmus belohnt dich für aktive Teilnahme am Netzwerk. Im Gegensatz zum traditionellen Mining brauchst du keine teure Hardware - nur deine Kreativität und dein Engagement.',
