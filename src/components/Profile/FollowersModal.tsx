    ...
    const fetchUsers = async () => {
      ...
      try {
        ...
        if (activeTab === 'followers') {
          ...
          const followersData = await userRelationshipAPI.getFollowers(userId);
          data = followersData.map(item => ({
            ...item,
            isFollowing: false // Wird später aktualisiert
          }));
        } else {
          // Hole alle Benutzer, denen userId folgt
          const followingData = await userRelationshipAPI.getFollowing(userId);
          data = followingData.map(item => ({
            ...item,
            isFollowing: false // Wird später aktualisiert
          }));
        }
