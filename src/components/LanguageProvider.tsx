...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'register.subtitle': 'Erstelle dein BSN-Konto und starte deine Blockchain-Reise',
    'register.username': 'Benutzername',
    'register.usernamePlaceholder': 'Dein Benutzername',
    ...
    'register.emailPlaceholder': 'deine.email@beispiel.de',
    'register.password': 'Passwort',
    'register.passwordPlaceholder': 'Dein sicheres Passwort',
  ...
  en: {
    ...
    'register.subtitle': 'Create your BSN account and start your blockchain journey',
    ...
    'register.passwordPlaceholder': 'Your secure password',
